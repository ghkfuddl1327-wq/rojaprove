...
## What rojaprove covers

rojaprove tests the **AI layer** — where an LLM mediates the response. v0.1 focuses on **system prompt disclosure**. It does **not** cover traditional web/API vulnerabilities (SQL injection, auth bypass, etc.) — those belong to standard DAST/pentest tooling.
